...
class ToolTip:
    def __init__(self, master, image=None, delay=1500, **opts):
        self.master = master
        self._opts = {'anchor':'center', 'bd':1, 'bg':'lightyellow', 'delay':delay, 'fg':'black',\
                      'follow_mouse':0, 'font':None, 'justify':'left', 'padx':4, 'pady':2,\
                      'relief':'solid', 'state':'normal', 'image':image, 'text':None, 'textvariable':None,\
...
def demo():
    ...
    l.pack(side='top')
    import ImageTk
    image = ImageTk.Image.open('resources/placeholder.png')
    photo = ImageTk.PhotoImage(image)
    t1 = ToolTip(l, follow_mouse=1, image=photo)
